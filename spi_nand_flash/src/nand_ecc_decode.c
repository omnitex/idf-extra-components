...
nand_ecc_status_t nand_ecc_decode_gd_eccse(uint8_t status_c0, uint8_t status_f0, bool f0_read_ok)
{
    unsigned eccs = PACK_2BITS_STATUS(status_c0, STAT_ECC1, STAT_ECC0);
    ...
    return s_ecc_gd_eccse_map[PACK_2BITS_STATUS(status_f0, STAT_ECC1, STAT_ECC0)];
}
