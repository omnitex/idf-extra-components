...
/* Setup TODO comment explanations */
#define SPI_FLASH_FREQ_KHZ      40000
#define SPI_IO_MODE SPI_NAND_IO_MODE_SIO
#define SPI_ENABLE_WP_HD_PINS false
#define GC_RESERVE_OVERHEAD_PERCENT 20
...
static void example_init_nand_flash(spi_nand_flash_device_t **out_handle, spi_device_handle_t *spi_handle,
                                    perf_spi_hw_config_t *out_hw)
{
    const spi_bus_config_t bus_config = {
        .mosi_io_num = PIN_MOSI,
        .miso_io_num = PIN_MISO,
        .sclk_io_num = PIN_CLK,
        .quadhd_io_num = SPI_ENABLE_WP_HD_PINS ? PIN_HD : -1,
        .quadwp_io_num = SPI_ENABLE_WP_HD_PINS ? PIN_WP : -1,
    ...
    spi_device_interface_config_t devcfg = {
        .clock_speed_hz = SPI_FLASH_FREQ_KHZ * 1000,
        .mode = 0,
        .spics_io_num = PIN_CS,
        .queue_size = 10,
        .flags = spi_flags,
    ...
    *out_hw = (perf_spi_hw_config_t) {
        .clock_khz       = SPI_FLASH_FREQ_KHZ,
        .io_mode         = (uint8_t)nand_flash_config.io_mode,
        .half_duplex     = (spi_flags & SPI_DEVICE_HALFDUPLEX) != 0,
        .quad_pins_wired = (bus_config.quadwp_io_num != -1),
        .dma_chan        = SPI_DMA_CHAN,
        .max_transfer_sz = bus_config.max_transfer_sz,
        .gc_factor       = nand_flash_config.gc_factor,
        .gc_percentage   = GC_RESERVE_OVERHEAD_PERCENT,
    };
}
...
void app_main(void)
{
    ...
    perf_spi_hw_config_t hw_cfg;
    example_init_nand_flash(&flash, &spi, &hw_cfg);
